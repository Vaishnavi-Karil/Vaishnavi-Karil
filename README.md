...
Worked on **enterprise-scale production applications**, cloud deployments, and modern architectures like **Microservices** and **Microfrontend**.
...
### **Neosoft Pvt. Ltd. — Full Stack MERN Developer** *(Present)*

- Developed and maintained **enterprise-level web applications**
- Built **RESTful APIs** using **Node.js & Express**
- Worked professionally with **MongoDB (Mongoose)** and **PostgreSQL (pg + raw SQL queries)**
- Implemented **JWT-based authentication & authorization**
- Experience with **cloud deployments & CI/CD pipelines**
...
- Phixman Product Web Application
- Complete frontend ownership using React.js
...
- Reusable UI components using React & Material UI
...
- ✅ **Microfrontend Architecture Certification**

---

## 🗄️ Database Expertise (Professional)

### **MongoDB**
- Schema design using Mongoose
- Aggregations, indexing, optimization
- Used in production applications

### **PostgreSQL**
- pg library with raw SQL queries
